...
#### app ###
-dontwarn com.maple.dev_template_flutter.db.**
-keep class com.maple.dev_template_flutter.db.**{*;}
-dontwarn com.maple.dev_template_flutter.model.**
-keep class com.maple.dev_template_flutter.model.**{*;}
-dontwarn com.maple.dev_template_flutter.widget.**
-keep class com.maple.dev_template_flutter.widget.**{*;}
#### app ###
...
# 打印SDK
-dontwarn com.example.lc_print_sdk.**
-keep class com.example.lc_print_sdk.** { *; }
# 扫描SDK
...
-dontwarn com.ta.a.**
-keep public class com.ta.a.**{*;}

# USDK
-dontwarn com.ubx.usdk.**
-keep public class com.ubx.usdk.**{*;}
-dontwarn com.rfid.**
-keep public class com.rfid.**{*;}
-dontwarn com.module.interaction.**
-keep public class com.module.interaction.**{*;}
-dontwarn com.util.**
-keep public class com.util.**{*;}
-dontwarn com.nativec.tools.**
-keep public class com.nativec.tools.**{*;}
-dontwarn com.ubx.mylibrary.**
-keep public class com.ubx.mylibrary.**{*;}
-dontwarn com.iflytek.rfiddrive.**
-keep public class com.iflytek.rfiddrive.**{*;}
-dontwarn com.rfid.trans.**
-keep public class com.rfid.trans.**{*;}
